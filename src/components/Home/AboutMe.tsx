...
import { AboutMe as TAboutMe } from "@/src/types/Home";
...
export const AboutMe = ({ aboutMe }: AboutMeProps) => {
  ...
  return(
    <main className="flex flex-wrap-reverse justify-center items-center gap-10 md:gap-32 py-8 text-lg text-center xl:text-left xl:flex-nowrap xl:jutify-between">
      <div className="text-white flex flex-col items-center xl:items-start gap-4 w-full xl:w-120">
        ...
        <ul className="flex flex-wrap jutyfy-center xl:grid xl:grid-cols-2 xl:w-fit gap-3 text-xl">
